...
if scenario == 1
    ...
    obs4_center = [(10.25/16)*x_VE_lim;(2/16)*y_VE_lim];
...
elseif scenario == 2
    ...
    obs3_center = [(6.75/16)*x_VE_lim;(7/16)*y_VE_lim];
    obs4_center = [(6.5/16)*x_VE_lim;(2/16)*y_VE_lim];
    target_center = [(14/16)*x_VE_lim;(5/16)*y_VE_lim];
elseif scenario == 3
    obs1_center = [(5/16)*x_VE_lim;(8/16)*y_VE_lim];
    obs2_center = [(6/16)*x_VE_lim;(3/16)*y_VE_lim];
    obs3_center = [(10/16)*x_VE_lim;(7/16)*y_VE_lim];
    obs4_center = [(10.5/16)*x_VE_lim;(2/16)*y_VE_lim];
    target_center = [(2/16)*x_VE_lim;(7/16)*y_VE_lim];
elseif scenario == 4
    obs1_center = [(11/16)*x_VE_lim;(8/16)*y_VE_lim];
    obs2_center = [(10/16)*x_VE_lim;(3/16)*y_VE_lim];
    obs3_center = [(6/16)*x_VE_lim;(7/16)*y_VE_lim];
    obs4_center = [(6/16)*x_VE_lim;(2/16)*y_VE_lim];
    target_center = [(14/16)*x_VE_lim;(7/16)*y_VE_lim];
end 
